...
@Gooey(
    ...
    program_name="Pytheas visualization of annotated spectra",
...
def visualizer():
    ...
    parser.add_argument(
        ...
        default=None,
        type=int,
        help="Minimum m/z value for the spectra " "(default=based on mgf)",
    )
    parser.add_argument(
        "--spectra_mz_maximum",
        default=None,
        type=int,
        help="Maximum m/z value for the spectra " "(default=based on mgf)",
    )
    ...
    visualization = Visualize(
        ...
        args.MS_data,
        args.Match_output,
        args.MS2_peaks_number,
        args.spectra_mz_minimum,
        args.spectra_mz_maximum,
        args.Sp_minimum,
        args.dSp_maximum,
        args.visualize_decoys,
        args.modified_only,
        args.rank_maximum,
        args.unique_positions_only,
        args.remove_redundant_SeqX_matches,
        args.dSp2_minimum,
        args.MS1_ppm_cutoff,
    )
