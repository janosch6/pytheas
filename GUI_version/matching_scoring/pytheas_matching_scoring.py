...
@Gooey(
    ...
    program_name="Pytheas matching and scoring",
...
def matching_scoring():
    ...
    parser.add_argument(
        "--MS2_ppm", default=50, type=float, help="MS2 ions matching tolerance in ppm"
    )
    parser.add_argument(
        "--MS1_offset",
        default=0,
    ...
    match = Match(
        ...
        args.MS1_offset,
        args.MS2_offset,
        args.MS2_absolute_peak_intensity,
        args.MS2_most_intense_peaks,
        args.precursor_exclusion_window,
        args.precursor_losses_exclusion_window,
        args.beta,
        args.alpha,
        args.MS2_relative_peak_intensity,
        args.isotopologue_precursor_matching,
        args.exclude_precursor_charge_matching,
        args.FDR_isotopic_species,
        args.targets_without_decoys,
    )
