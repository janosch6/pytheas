...
@Gooey(
    ...
    program_name="Pytheas in silico digestion",
...
def in_silico_digest():
    ...
    parser.add_argument(
        "Enzyme",
        choices=["A", "T1", "U2", "Cus", "MC1", "MAZ", "none", "nonspecific"],
        help="RNA endonuclease for the in silico digestion",
        gooey_options={
            "validator": {
    ...
    # Optional Arguments
    parser.add_argument(
        "--decoys", action="store_true", default=False, help="Add decoy sequences"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help="MS2 ion series for m/z calculation (Hold Ctrl for multiple " "selection)",
    )
    parser.add_argument(
        "--SeqX_consolidation",
        action="store_true",
    ...
    parser.add_argument(
        ...
        default=400,
        type=int,
        help="Minimum value of the precursor ions m/z",
    )
    parser.add_argument(
        "--MS1_mz_max",
        default=2000,
    ...
    enzyme = Enzyme_cleavage(
        args.RNA_sequences,
        args.Enzyme,
        args.enzyme_missed_cleavages,
        args.nonspecific_cleavage_min_length,
        args.nonspecific_cleavage_max_length,
        args.cleaved_RNA_5end_chemistry,
        args.cleaved_RNA_3end_chemistry,
        args.RNA_5end_chemistry,
        args.RNA_3end_chemistry,
    )
    enzyme.final_output()
    ...
    calc_mass = Masses(
        args.Ion_mode,
        args.Nucleotides_light,
        args.Nucleotides_heavy,
        args.MS1_charges_table,
        args.MS2_charges_table,
        args.MS1_mz_min,
        args.MS1_mz_max,
        args.MS2_mz_min,
        args.MS2_mz_max,
        args.CID_HCD_series,
        args.SeqX_consolidation,
        args.MS1_SeqX,
        args.MS2_SeqX,
        args.RNA_sequences,
    )
