    ...
    with open("./" + args.match_file, "r") as input_file:
        for line in input_file:
            ...
            if line[0].isdigit():
                ...
                if (
                    float(score) >= args.Sp_minimum_cutoff
                    and float(dSp) <= args.dSp_maximum_cutoff
                    and decoys_string not in molecule
                    and mod_string in mod
                    and len(unique_list) <= unique_length
                    and rank <= args.rank_max
                ):
    ...
    with open(args.match_file, "r") as input_file:
        for line in input_file:
            if line[0].isdigit():
                ...
                d["sequence"].append(sequence), d["rank"].append(rank), d["Sp"].append(
                    score
                )
